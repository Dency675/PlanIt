...
// const uploadTeamMember = async (req: Request, res: Response) => {
//   try {
...
//           const teamMember = csvData.map((record) => record.estimationName);

//           // Check for existing teammembers
//           const existingEstimations = await teamMemberInformation.findAll({
//             where: {
...
//           }
//           else {
//             const newEstimation = await teamMemberInformation.bulkCreate(csvData);
